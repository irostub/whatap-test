...
<div class="absolute inset-x-10 top-10">
  <div class="flex justify-end items-center">
    <a href="/orders/add"
      class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-3 px-6 mr-4 rounded">주문 등록</a>
    <a href="/orders/all"
      class="align-middle bg-blue-500 hover:bg-blue-700 text-white font-bold py-3 px-6 rounded">모든 주문 보기</a>
  </div>
</div>
<div class="flex flex-col h-screen justify-center items-center">
  <div class="w-3/4 text-center">
      <h2 class="text-5xl font-normal leading-normal mt-0 mb-5 text-gray-600">주문 서비스</h2>
