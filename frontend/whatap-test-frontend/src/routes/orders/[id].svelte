...
<div class="absolute inset-x-10 top-10">
  <div class="flex justify-end items-center">
    <a href="/orders/update/{data.id}"
      class="bg-emerald-500 hover:bg-emerald-700 text-white font-bold py-3 px-6 mr-4 rounded">주문 수정</a>
    <button
    on:click={onDeleteButtonClick}
      class="align-middle bg-red-500 hover:bg-red-700 text-white font-bold py-3 px-6 rounded">주문 삭제</button>
  </div>
</div>
<div class="flex flex-col h-screen justify-center items-center">
  <div class="w-3/4 text-center">
      <h2 class="text-5xl font-normal leading-normal mt-0 mb-5 text-gray-600">주문 상세</h2>
    <table class="divide-y divide-gray-300 w-full">
        ...
        <tbody class="bg-white divide-y divide-gray-300">
          ...
          class="whitespace-nowrap">
            <td>주문 총 가격</td>
            <td>{data.quantity * data.productResponse.price}</td>
          </tr>
          <tr
          class="whitespace-nowrap">
            <td>주문상태</td>
          ...
          class="whitespace-nowrap">
            <td>상품명</td>
            <td>{data.productResponse.name}</td>
          </tr>
          <tr
          class="whitespace-nowrap">
            <td>상품가격</td>
            <td>{data.productResponse.price}</td>
          </tr>
        </tbody>
      </table>
  </div>
